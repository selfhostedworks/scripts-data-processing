...
from image_processor import change_image_type, resize_image,\
     convert_to_greyscale, add_background_color
...
for line in data:
    try:       
        image_url = line[5]
        if image_url:
            filename = get_image_name(line[1])
...
if not args.no_header:
    output_data.pop(0)
html_from_data('logo-table.html', output_data)
